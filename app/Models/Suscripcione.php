 ...
 * 
 * @property TerminosCondicione $terminos_condicione
...
class Suscripcione extends Model
{
	...
	public function terminos_condicione()
	{
		return $this->belongsTo(TerminosCondicione::class, 'terminos_condiciones_id');
	}
