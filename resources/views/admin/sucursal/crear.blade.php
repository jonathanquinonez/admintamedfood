...
<div class="row grid-margin">
    ...
    <br>
    <h5 class="ml-3">Crear Sucursal</h5>
</div>
            <div class="modal-body">
                <div class="row">
                    <form action="{{ url('crearsucursal') }}" enctype="multipart/form-data" method="POST" name="f1" id="f1">
                        {{ csrf_field() }}
                        <div class="row">
                        <div class="col-6">
                            ...
                            <div id="the-basics">
                                <input class="typeahead" name="nombre"  required="" type="text" value="{{ old('nombre') }}">
                        ...
                        <div class="col-6">
                                ...
                                <label>Ciudad</label>
                                <input class="typeahead" name="ciudad"  autocomplete="off" value="{{ old('ciudad') }}" list="n">
                         ...
                         <div class="col-6">
                            ...
                            <div id="the-basics">
                                <input class="typeahead" name="nombre_contacto"  required="" type="text" value="{{ old('nombre_contacto') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div id="the-basics">
                                <input class="typeahead" name="telefono_contacto"  required="" type="text" value="{{ old('telefono_contacto') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div id="the-basics">
                                <input class="typeahead" name="direccion"  type="text" value="{{ old('direccion') }}">
                        ...
                        <div class="col-6">
                            ...
                            <div id="bloodhound">
                                <input class="typeahead" name="correo" required="" type="email" value="{{ old('correo') }}">
                         ...
                         <div class="col-6">
                            ...
                            <div id="bloodhound">
                                <input class="typeahead" name="longitud"  id="longitud"  readonly="" type="text" value="{{ old('nombre') }}">
                         ...
                         <div class="col-6">
                            ...
                            <div id="bloodhound">
                                <input class="typeahead" name="latitud" id="latitud"  readonly="" type="text" value="{{ old('nombre') }}">
                        ...
                        <div class="col-12">
                                ...
                                <input class="btn btn-success" name="crear"  type="submit" value="Crear">
