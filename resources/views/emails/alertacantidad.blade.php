...
<head>
  <meta charset="UTF-8">
  <title>Alerta de existencia de producto</title>
    ...
    bgcolor="#F4F7FA">
      <tbody>
        <tr>
          ...
          El siguiente producto supera el limite de existencias establecido.
        </span>
                                ...
                                <tr>
                                  ...
                                  <td align="center" style="color:#48545d;font-size:14px;line-height:24px;">
                                    <ul style="list-style: none; padding-left: 0; margin-top: 0; margin-bottom: 0;">
                                      ...
                                      <li><b>{{$producto->cantidad_existente}}</b></li>
                                    </ul>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="center">
                                    <p style="color:#48545d;font-size:14px;line-height:24px;">Si tienes dudas o quieres que resolvamos alguna inquietud <a href="mailto:soporte@bitu.com.co?subject=Alerta de montos" style="color:#420AB7">cont&aacute;ctanos
