    ...
    bgcolor="#F4F7FA">
      <tbody>
        <tr>
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                    <img alt="password" width="80" src="https://bitu.s3-us-west-2.amazonaws.com/Emails/Imagenes/password.png"
                                    />
                                  </td>
                                </tr>
                                <tr>
          ...
          Se ha generado un c&oacute;digo de seguridad para ingresar a la Plataforma Bitu. C&oacute;pialo e ingr&eacute;salo en el campo identificado como <b>PIN DE SEGURIDAD</b>. Este c&oacute;digo puede ser utilizado una sola vez.
                                ...
                                <tr>
                                  <td align="center" style="color:#48545d;font-size:14px;line-height:24px;">
                                      <li style="list-style: none">Tu PIN de Seguridad es:</li>
                                ...
                                <tr>
                                  <td align="center">
                                    <span style="color:#48545d;font-size:14px;line-height:24px;">Si tu no realizaste esta solicitud, ignora este correo o <a href="mailto:soporte@bitu.com.co?subject=Pin de Seguridad" style="color:#420AB7">cont&aacute;ctanos
						                </a>o vis&iacute;tanos en nuestra
  							           <a href="https://www.bitu.com.co" style="color:#420AB7">pagina web</a>.</span>
                                  </td>
                                </tr>
                                  <tr>
                                  <td height="10" &nbsp;=""></td>
