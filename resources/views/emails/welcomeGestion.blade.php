...
<head>
  <meta charset="UTF-8">
  <title>Bienvenidos a Bitu</title>
    ...
    bgcolor="#F4F7FA">
      <tbody>
        <tr>
                              ...
                              <tbody>
                                <tr>
                                  <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                    <img alt="establecimiento" width="80" src="https://bitu.s3-us-west-2.amazonaws.com/Emails/Imagenes/admin.png"
                                    />
                                  </td>
                                </tr>
                                <tr>
          ...
          Bienvenidos a la Plataforma Bitu
        </span>
                                ...
                                <tr>
                                  <td align="left"> <span style="color:#48545d;font-size:14px;line-height:24px;">
          Hola {{$user->nombre}}
        </span>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                      ¡Gracias por hacer parte de Bitu! A trav&eacute;s de la plataforma podr&aacute;s hacer gesti&oacute;n de tus usuarios, actualización de cupos de dinero y el reporte detallado de transacciones de cada usuario.
                                    </span>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="center" style="color:#48545d;font-size:14px;line-height:24px;">
                                      <li style="list-style: none">Correo electr&oacute;nico:</li>
                                      <li style="list-style: none"><b>{{$user->email}}</b></li>
                                  </td>
                                </tr>
                                  <tr>
                                  <td height="10" &nbsp;=""></td>
                                  ...
                                  <tr>
                                  <td align="center" style="color:#48545d;font-size:14px;line-height:24px;">
                                      <li style="list-style: none">Contrase&ntilde;a Temporal:</li>
                                      <li style="list-style: none"><b>{{$user->pin_seguridad}}</b></li>
                                    </ul>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                      Una vez ingreses a la aplicaci&oacute;n te solicitamos cambiar tu contrase&ntilde;a a trav&eacute;s de las opciones del perfil. Para iniciar, haz click aqu&iacute; abajo.
                                    </span>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
                                    <a href="https://gestion.bitu.com.co/" style="display:block; padding:15px 25px; background-color:#420AB7; color:#ffffff; border-radius:10px; text-decoration:none; margin-top:20px;">ENTRAR A LA PLATAFORMA</a>
                                  </td>
                                </tr>
                                <tr>
                                  <td height="10" &nbsp;=""></td>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                      Si tienes dudas o quieres que resolvamos alguna inquietud <a href="mailto:soporte@bitu.com.co?subject=Ingreso por primera vez" style="color:#420AB7">cont&aacute;ctanos
						                </a>o vis&iacute;tanos en nuestra
  							           <a href="https://www.bitu.com.co" style="color:#420AB7">pagina web</a>.
                                      </span>
                                  </td>
                                </tr>
                                  <tr>
